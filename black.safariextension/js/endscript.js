...
cljs.core.UUID;
goog.provide("black.end");
goog.require("cljs.core");
black.end.handleMessage = function handleMessage(event) {
  return alert("HERE!")
};
goog.exportSymbol("black.end.handleMessage", black.end.handleMessage);
safari.self.addEventListener("message", black.end.handleMessage, false);
